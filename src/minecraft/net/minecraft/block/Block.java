...
public class Block
{
    ...
    {
        /*CollideEvent collide = new CollideEvent(this.getCollisionBoundingBox(worldIn, pos, state), state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
        Lust.INSTANCE.getEventProtocol().handleEvent(new CollideEvent(collide));*/
        //TODO: Fix Collide hook
