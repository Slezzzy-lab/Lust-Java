...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        PostProcessing postProcessing = Lust.INSTANCE.getModuleCollection().getModule(PostProcessing.class);
        postProcessing.blur();

        Lust.INSTANCE.getEventProtocol().handleEvent(new Render2DEvent(scaledresolution));

        NotificationsMod notificationsMod = Lust.INSTANCE.getModuleCollection().getModule(NotificationsMod.class);
        notificationsMod.render();
