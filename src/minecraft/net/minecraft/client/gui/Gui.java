...
public class Gui
{
   ...
   /*     float f = (float) (startColor >> 24 & 255) / 255.0F;
    ...
    public static void drawGradientRect2(float x, float y, float width, float height, int startColor, int endColor) {
     ...
     */
    protected static void drawGradientRect(float left, float top, float right, float bottom, int startColor, int endColor)
    {
        float f = (float)(startColor >> 24 & 255) / 255.0F;
        float f1 = (float)(startColor >> 16 & 255) / 255.0F;
        float f2 = (float)(startColor >> 8 & 255) / 255.0F;
