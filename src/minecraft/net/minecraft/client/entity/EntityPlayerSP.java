...
import dev.cedo.lust.module.impl.player.NoSlowMod;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Lust.INSTANCE.getEventProtocol().handleEvent(event);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Lust.INSTANCE.getEventProtocol().handleEvent(motionEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Lust.INSTANCE.getModuleCollection().get(NoSlowMod.class).isEnabled()) {
