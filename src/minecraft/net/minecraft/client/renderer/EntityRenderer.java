...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            boolean flag = false;
            boolean flag1 = true;
            double reach = (Lust.INSTANCE.getModuleCollection().getModule(ReachMod.class).isEnabled() ? ReachMod.reach.getValue() : 3.0D);
            ...
            if (this.mc.objectMouseOver != null) {
                d1 = this.mc.objectMouseOver.hitVec.distanceTo(vec3) - 3 + reach;
            }
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > 3) {
                this.pointedEntity = null;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Lust.INSTANCE.getEventProtocol().handleEvent(new Render3DEvent());
