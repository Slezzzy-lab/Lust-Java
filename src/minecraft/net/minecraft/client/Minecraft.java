...
import dev.cedo.lust.ProtectedLaunch;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public void shutdown() {
        Lust.INSTANCE.getEventProtocol().handleEvent(new GameCloseEvent());
        this.running = false;
    }
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Lust.INSTANCE.getEventProtocol().handleEvent(new KeyPressEvent(k));
