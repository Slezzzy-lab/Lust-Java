...
package dev.cedo.lust.ui.altManager;
...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 69:{
                try{
                    String[] args = ((String) Toolkit.getDefaultToolkit().getSystemClipboard().getData(DataFlavor.stringFlavor)).split(":");
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, width / 2 - 100, var3 + 72, "Login"));
        this.buttonList.add(new GuiButton(69, width / 2 - 100, var3 + 72 + 24 , "Clipboard"));
        this.buttonList.add(new GuiButton(1, width / 2 - 100, var3 + 72 + 24 + 24, "Back"));
