...
public class MinecraftFontRenderer extends CFont {
    ...
    public void drawStringWithShadow(String text, float x2, float y2, Color color) {
        drawStringWithShadow(text, x2, y2, color.getRGB());
    }


    public int drawString(String text, float x2, float y2, int color, boolean shadow) {
        GlStateManager.color(1, 1, 1, 1);
        if (shadow) return this.drawStringWithShadow(text, x2, y2, color);
    ...
    public void drawString(String text, float x2, float y2, Color color) {
        drawString(text, x2, y2, color.getRGB());
    }
    ...
    public int drawCenteredString(String text, float x2, float y2, int color) {
        return this.drawString(text, x2 - (this.getStringWidth(text) / 2), y2, color);
    }

    public void drawCenteredString(String text, float x2, float y2, Color color) {
        this.drawString(text, x2 - (this.getStringWidth(text) / 2), y2, color);
    }
